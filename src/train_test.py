...
from datasets import train_test_split, dummy_get_dataloaders
...
if __name__ == "__main__":
    ...
    dataloaders_dict = dummy_get_dataloaders(train_val_class_counts_dict, input_size=input_size, batch_size=batch_size)
